...
- **Открытый исходный код, без рекламы, без телеметрии.**
...
- Микс, который постоянно подкидывает новое от артистов, которых вы уже слушаете
- Тексты песен почти для чего угодно, даже для нишевых треков.
